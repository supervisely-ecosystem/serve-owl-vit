...
This app is based on the model `OWL-ViT`. Check it out on [github](https://github.com/google-research/scenic/tree/main/scenic/projects/owl_vit). ![GitHub Org's stars](https://img.shields.io/github/stars/google-research/scenic?style=social)
